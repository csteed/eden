...
public class PCPanel extends JComponent implements ActionListener,
	...
	private final static Color QUERY_RANGE_LABEL_BACKGROUND = new Color(230,
			230, 250, 140);
	...
	private boolean showAxesAsBars = true;
...
//		log.debug("in paintComponent");
	...
	protected void layoutAxes() {
		...
		for (int iaxis = 0; iaxis < axisList.size(); iaxis++) {
			...
			axis.rectangle = new Rectangle(axis.xPosition - (axisSpacing / 2),
					axis.topPosition, axis.axisWidth, axis.axisHeight);

			axis.axisBarRectangle = new Rectangle(axis.xPosition
					- (axisBarWidth / 2), axis.topPosition, axisBarWidth,
					axisHeight);
			...
			Rectangle scatterplotRect = new Rectangle(scatterplotX,
					scatterplotY, scatterplotSize, scatterplotSize);
